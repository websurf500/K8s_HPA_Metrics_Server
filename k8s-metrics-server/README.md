...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/suffixscope/k8s-metrics-server.git and run the following command from
